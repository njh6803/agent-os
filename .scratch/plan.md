...
프론티어: first-slice 가 2026-09-21 에 닫혔다(PR #16~#23). interrupts 가 2026-09-22 에 닫혔다(PR #29~#37). admin-api 가 2026-09-24 에 닫혔다(티켓 01~06, PR #42 부터). http-channel 이 2026-09-26 에 닫혔다(티켓 01~05, PR #70 부터). 지금은 plugin-toggle, web-admin 둘이 열려 있다. web-admin 은 http-channel 이 닫히며 풀렸다(생성기를 고르는 측정이 채널 라우트가 붙은 계약 파일을 요구했다).
