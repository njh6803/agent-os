...
- Actions 무료 분량은 계정 단위 월 2,000분이고 모든 비공개 저장소가 나눠 쓴다. 2026-09-20 PR #10에서 소진돼 잡이 시작조차 안 됐다(주석은 결제 실패나 지출 한도를 말하지만 화면은 2,000/2,000). CI가 최종 판정인 구조는 분량이 막히면 병합도 막힌다는 뜻이다. 선택지는 예산, 공개 전환, 리셋 대기. 런북 1단계의 플랜 확인에 남은 분량도 포함한다.
