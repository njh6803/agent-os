...
- 2026-09-21 실측(첫 슬라이스 PR #16~#19, #21~#23. #20은 워크플로 PR): CodeRabbit PR 리뷰가 일곱 중 다섯에서 "Review rate limited"로 `pass`가 됐다. 한도가 예외가 아니라 기본 상태다. CLI 슬라이스 리뷰(findings 0)를 각 PR 코멘트로 링크해 대체했고 operations.md에 규약으로 적었다.
