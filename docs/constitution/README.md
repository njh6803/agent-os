...
**Version**: 2.3.0 | **Ratified**: 2026-09-19 | **Last Amended**: 2026-09-21 (ADR 0001~0006). 2.1.0은 원격·CI·PR을 첫날부터로 바꾼 것, 2.2.0은 리뷰 파이프라인 절 추가, 2.2.1은 CodeRabbit PR 리뷰를 빼고 CLI만 남긴 것, 2.3.0은 거버넌스에 "ADR은 결정 단위" 문장을 더하고(절 추가라 minor) 2.1.0~2.2.1을 ADR 0005·0006으로 소급한 것
