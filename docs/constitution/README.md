...
**Version**: 2.2.1 | **Ratified**: 2026-09-19 | **Last Amended**: 2026-09-20 (ADR 0001~0004). 2.1.0은 원격·CI·PR을 첫날부터로 바꾼 것, 2.2.0은 리뷰 파이프라인 절 추가, 2.2.1은 CodeRabbit PR 리뷰를 빼고 CLI만 남긴 것
