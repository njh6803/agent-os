...
- [operations.md](operations.md): 검증, LLM 테스트, 가드레일, 브랜치, 이슈, 환경 규약. 커밋·병합·트래커를 만질 때 읽는다.
...
**Version**: 2.1.0 | **Ratified**: 2026-09-19 | **Last Amended**: 2026-09-20 (ADR 0001~0004). 2.1.0은 원격·CI·PR을 첫날부터로 바꾼 것
